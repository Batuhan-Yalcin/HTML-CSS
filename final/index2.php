...
<body>
    <section id="menu">     <!--  Menü Alanı İçin Section ile Üst Bölüm Tanımlama  -->
        <div id="logo">Yazılım Okulu</div> <!--  LOGOYU OLUŞTURMAK İÇİN KURULAN DİV   -->
        <nav>
    ...
    <section id="hakkimizda">
        ...
        <div class="container"> <!--   HAKKIMIZDA KISMININ KAPSAYICI DİVİ CONTAİNER !    -->
            ...
            <img src="resim/r8.jpg" alt="" class="birinciimg ikinciimg">
    ...
    <!--                        EKİP KISMI BAŞLANGIÇ !                      -->
        ...
        <div class="container">
            ...
            <div class="sutun-sol-sag">
                ...
                <h4 class="ekipisim">Batuhan Yalçın</h4>
            ...
            <div class="container">
                ...
                <div id="iletisimopak">
                    ...
                    <div class="adres">
                        ...
                        <p class="adresp">Çeltik Sokak No:123</p>
                        <p class="adresp">0212 555 79 79</p>
                        <p class="adresp">Email : YazılımOkulu@gmail.com</p>
                    </div>
                </div>
                </form>
                <footer>
